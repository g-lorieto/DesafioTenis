<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HabilitarJugadorUserControl.ascx.cs" Inherits="DesafioTenisWEB.UserControls.HabilitarJugadorUserControl" %>
